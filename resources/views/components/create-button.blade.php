...
<a href="{{ $href }}" {{ $atributes->merge(['class' => 'inline-flex items-center px-4 py-2
...
daerk:focus:bg-white active:bg-gray-900 dark:active:bg-gray-300 focus:outline-none focus:ring-2
